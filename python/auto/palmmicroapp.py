...
class PalmmicroApp:
	...
	def create_dataframe(self):
		self.arSinaStock = SinaStock.TaskInit('fx_susdcny,hf_ES,hf_CL,hf_GC,hf_NQ,nf_AG0')
	...
	def create_treeview(self, parent):
		...
		columns = ['Symbol', 'Hedge', 'Type', 'Time', 'Percent', 'SymbolSize', 
				   'SymbolPrice', 'HedgeSize', 'HedgePrice', 'Note']
		
		# 列显示名称
		display_names = ['代码', '对冲代码', '方向', '时间', '溢价', '数量', 
						 '价格', '对冲数量', '对冲价格', '补充内容']
