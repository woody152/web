...
require_once('php/_editmergeform.php');
...
function _echoMyStockData($ref, $strStockId, $bAdmin)
{
    ...
    if ($ref->IsFundA())
    {
		...
		{
			EchoFundArrayEstParagraph([$fund]);
   	...
   	{
		EchoFundArrayEstParagraph([$fund_pair_ref]);
		EchoFundListParagraph([$fund_pair_ref]);
